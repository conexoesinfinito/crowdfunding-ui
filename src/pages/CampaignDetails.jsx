    ...
    <div>
      ...
      >
        ...
        >
          ...
          />
          <ContBox title="Total Backers" value={donators.length} />
        </div>
      </div>
      ...
      >
        ...
        <div className="flex-1">
          ...
          <div
            className="mt-[20px] flex flex-col p-4 bg-[#1c1c24]
          rounded-[10px]"
          >
            <p
              className="font-epilogue font-medium
            ...
            <div className="mt-[30px]">
              <input
                ...
                text-white text-[18px] leading-[30px] 
              ...
              >
                <h4
                  className="font-epilogue font-semibold text-[14px]
                    leading-[22px] text-white uppercase"
                >
                  Back it because you believe in it
                </h4>
                <p
                  className="mt-[20px] font-epilogue font-normal
                     text-[#808191] leading-[22px]
                      text-center"
                >
                  Support the project for no reward just because it speak to you
                </p>
              </div>
