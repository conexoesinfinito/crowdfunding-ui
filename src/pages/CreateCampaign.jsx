...
import { CustumoButtom, FormField, Loader } from '../components'
      ...
      >
        ...
        >
          ...
          <h4
           ...
           text-white ml-[20px]"
          >
            You will get 100% of the raisd amount
          </h4>
        </div>
        <div className="flex flex-wrap gap-[40px]">
          <FormField
        ...
        <FormField
          ...
          placeholder="Place image URL of your
            campaing"
          inputType="url"
          value={form.image}
